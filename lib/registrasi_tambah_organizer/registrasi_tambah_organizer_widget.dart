...
import 'registrasi_tambah_organizer_model.dart';
export 'registrasi_tambah_organizer_model.dart';

class RegistrasiTambahOrganizerWidget extends StatefulWidget {
  const RegistrasiTambahOrganizerWidget({super.key});

  @override
  State<RegistrasiTambahOrganizerWidget> createState() =>
      _RegistrasiTambahOrganizerWidgetState();
}

class _RegistrasiTambahOrganizerWidgetState
    extends State<RegistrasiTambahOrganizerWidget> {
  late RegistrasiTambahOrganizerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrasiTambahOrganizerModel());
