...
class DetailEventWidget extends StatefulWidget {
  const DetailEventWidget({super.key});

  @override
  State<DetailEventWidget> createState() => _DetailEventWidgetState();
}
...
class _DetailEventWidgetState extends State<DetailEventWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: CommonGroup.getDetailEventCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final detailEventGetDetailEventResponse = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Stack(
                children: [
                                ...
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://devfundation.propertio.id/${getJsonField(
                                      detailEventGetDetailEventResponse
                                          .jsonBody,
                                      r'''$.data.cover''',
                                    ).toString()}',
                                    width: double.infinity,
                                        ...
                                        return SingleChildScrollView(
                                          ...
                                          child: Row(
                                            ...
                                            children: List.generate(
                                                eventCategoriesDetail.length,
                                                (eventCategoriesDetailIndex) {
                                              final eventCategoriesDetailItem =
                  ...
                  if (FFAppState().userDataState.role == 'entrepreneur')
                    Align(
                            ...
                            children: [
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  borderWidth: 1.0,
                                  buttonSize: 40.0,
                                  fillColor: const Color(0xFF1B3E3B),
                                  icon: Icon(
                                  ...
                                  onPressed: () async {
                                    context.pushNamed('chatDetailEvent');
                                  },
                                ),
                              ),
                              FFButtonWidget(
