...
class TambahEvent1Model extends FlutterFlowModel<TambahEvent1Widget> {
  ...
  // State field(s) for categoryEvent widget.
  List<int>? categoryEventValue;
  FormFieldController<List<int>>? categoryEventValueController;
  ...
  List<String>? kategoriPartisipanValue;
  FormFieldController<List<String>>? kategoriPartisipanValueController;
