...
import 'ubah_kontraprestasi_widget.dart' show UbahKontraprestasiWidget;
import 'package:flutter/material.dart';

class UbahKontraprestasiModel
    extends FlutterFlowModel<UbahKontraprestasiWidget> {
  ...
  // Stores action output result for [Backend Call - API (Update Kontraprestasi)] action in buttonSimpan widget.
  ApiCallResponse? apiResult48f;
