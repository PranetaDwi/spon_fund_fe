...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    fundationAuthUserSubject.add(
      FundationAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<FundationAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  FundationAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = FundationAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    fundationAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
