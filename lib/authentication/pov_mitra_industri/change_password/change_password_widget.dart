...
class _ChangePasswordWidgetState extends State<ChangePasswordWidget> {
  ...
  void initState() {
    ...
    _model.newPasswordConfirmationTextController ??= TextEditingController();
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(16.0, 30.0, 16.0, 0.0),
                    child: TextFormField(
                      controller: _model.newPasswordConfirmationTextController,
                      focusNode: _model.newPasswordConfirmationFocusNode,
                      autofocus: true,
                      obscureText: !_model.newPasswordConfirmationVisibility,
                      decoration: InputDecoration(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.changePasswordResponse =
                                ...
                                newPasswordConfirmation: _model
                                    .newPasswordConfirmationTextController.text,
                              );
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content:
                                          const Text('Berhasil mengubah password'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
