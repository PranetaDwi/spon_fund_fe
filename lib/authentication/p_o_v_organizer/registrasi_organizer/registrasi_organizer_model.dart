...
import 'registrasi_organizer_widget.dart' show RegistrasiOrganizerWidget;
import 'package:flutter/material.dart';

class RegistrasiOrganizerModel
    extends FlutterFlowModel<RegistrasiOrganizerWidget> {
  ...
  // Stores action output result for [Backend Call - API (Register Organizer)] action in NextButton widget.
