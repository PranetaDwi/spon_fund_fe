...
import 'registrasi_tambah_organisasi_widget.dart'
    show RegistrasiTambahOrganisasiWidget;
import 'package:flutter/material.dart';

class RegistrasiTambahOrganisasiModel
    extends FlutterFlowModel<RegistrasiTambahOrganisasiWidget> {
  ...
  // Stores action output result for [Backend Call - API (Post Organization)] action in SubmitButton widget.
