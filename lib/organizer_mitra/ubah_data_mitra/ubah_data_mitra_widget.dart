...
import 'ubah_data_mitra_model.dart';
export 'ubah_data_mitra_model.dart';

class UbahDataMitraWidget extends StatefulWidget {
  const UbahDataMitraWidget({super.key});

  @override
  State<UbahDataMitraWidget> createState() => _UbahDataMitraWidgetState();
}

class _UbahDataMitraWidgetState extends State<UbahDataMitraWidget> {
  late UbahDataMitraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UbahDataMitraModel());

    _model.textController1 ??=
        TextEditingController(text: FFAppState().ProfileManagementState.name);
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if ((_model.postUpdateMitra?.succeeded ??
                                      true)) {
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: const Text('BERHASIL UPDATE'),
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(getJsonField(
                                            (_model.postUpdateMitra?.jsonBody ??
                                                ''),
                                            r'''$.data''',
                                          ).toString()),
                                          actions: [
